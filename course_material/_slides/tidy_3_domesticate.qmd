...
For this presentation we will only need the **`tidyverse`** package.
...
read_csv("../data/sst_NOAA.csv") %>% # Load the SACTN Day 1 data
  mutate(month = month(t)) %>% # Then create a month abbreviation column
  ...
  labs(x = NULL, y = "Temperature (°C)", colour = "Site") # Change labels
```